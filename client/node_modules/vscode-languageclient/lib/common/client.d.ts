...
import { DynamicFeature, FeatureClient, TextDocumentSendFeature, StaticFeature, TextDocumentProviderFeature, WorkspaceProviderFeature } from 'vscode-languageclient/lib/common/features';
import { DiagnosticProviderMiddleware, DiagnosticProviderShape, $DiagnosticPullOptions } from 'vscode-languageclient/lib/common/diagnostic';
import { NotebookDocumentMiddleware, $NotebookDocumentOptions, NotebookDocumentProviderShape } from 'vscode-languageclient/lib/common/notebook';
import { ConfigurationMiddleware, $ConfigurationOptions, DidChangeConfigurationMiddleware } from 'vscode-languageclient/lib/common/configuration';
import { DidChangeTextDocumentFeatureShape, DidCloseTextDocumentFeatureShape, DidOpenTextDocumentFeatureShape, DidSaveTextDocumentFeatureShape, TextDocumentSynchronizationMiddleware } from 'vscode-languageclient/lib/common/textSynchronization';
import { CompletionMiddleware } from 'vscode-languageclient/lib/common/completion';
import { HoverMiddleware } from 'vscode-languageclient/lib/common/hover';
import { DefinitionMiddleware } from 'vscode-languageclient/lib/common/definition';
import { SignatureHelpMiddleware } from 'vscode-languageclient/lib/common/signatureHelp';
import { DocumentHighlightMiddleware } from 'vscode-languageclient/lib/common/documentHighlight';
import { DocumentSymbolMiddleware } from 'vscode-languageclient/lib/common/documentSymbol';
import { WorkspaceSymbolMiddleware } from 'vscode-languageclient/lib/common/workspaceSymbol';
import { ReferencesMiddleware } from 'vscode-languageclient/lib/common/reference';
import { TypeDefinitionMiddleware } from 'vscode-languageclient/lib/common/typeDefinition';
import { ImplementationMiddleware } from 'vscode-languageclient/lib/common/implementation';
import { ColorProviderMiddleware } from 'vscode-languageclient/lib/common/colorProvider';
import { CodeActionMiddleware } from 'vscode-languageclient/lib/common/codeAction';
import { CodeLensMiddleware, CodeLensProviderShape } from 'vscode-languageclient/lib/common/codeLens';
import { FormattingMiddleware } from 'vscode-languageclient/lib/common/formatting';
import { RenameMiddleware } from 'vscode-languageclient/lib/common/rename';
import { DocumentLinkMiddleware } from 'vscode-languageclient/lib/common/documentLink';
import { ExecuteCommandMiddleware } from 'vscode-languageclient/lib/common/executeCommand';
import { FoldingRangeProviderMiddleware } from 'vscode-languageclient/lib/common/foldingRange';
import { DeclarationMiddleware } from 'vscode-languageclient/lib/common/declaration';
import { SelectionRangeProviderMiddleware } from 'vscode-languageclient/lib/common/selectionRange';
import { CallHierarchyMiddleware } from 'vscode-languageclient/lib/common/callHierarchy';
import { SemanticTokensMiddleware, SemanticTokensProviderShape } from 'vscode-languageclient/lib/common/semanticTokens';
import { LinkedEditingRangeMiddleware } from 'vscode-languageclient/lib/common/linkedEditingRange';
import { TypeHierarchyMiddleware } from 'vscode-languageclient/lib/common/typeHierarchy';
import { InlineValueMiddleware, InlineValueProviderShape } from 'vscode-languageclient/lib/common/inlineValue';
import { InlayHintsMiddleware, InlayHintsProviderShape } from 'vscode-languageclient/lib/common/inlayHint';
import { WorkspaceFolderMiddleware } from 'vscode-languageclient/lib/common/workspaceFolder';
import { FileOperationsMiddleware } from 'vscode-languageclient/lib/common/fileOperations';
/**
