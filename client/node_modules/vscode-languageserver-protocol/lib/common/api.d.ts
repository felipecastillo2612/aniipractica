...
export * from 'vscode-languageserver-protocol/lib/common/messages';
export * from 'vscode-languageserver-protocol/lib/common/protocol';
export { ProtocolConnection, createProtocolConnection } from 'vscode-languageserver-protocol/lib/common/connection';
