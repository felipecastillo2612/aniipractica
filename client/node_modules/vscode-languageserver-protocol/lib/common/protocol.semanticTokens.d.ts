...
import { MessageDirection, ProtocolRequestType, ProtocolRequestType0, RegistrationType } from 'vscode-languageserver-protocol/lib/common/messages';
import type { PartialResultParams, WorkDoneProgressParams, WorkDoneProgressOptions, TextDocumentRegistrationOptions, StaticRegistrationOptions } from 'vscode-languageserver-protocol/lib/common/protocol';
/**
 * @since 3.16.0
 */
