...
import { MessageDirection, ProtocolRequestType } from 'vscode-languageserver-protocol/lib/common/messages';
import type { TextDocumentRegistrationOptions, StaticRegistrationOptions, TextDocumentPositionParams, PartialResultParams, WorkDoneProgressParams, WorkDoneProgressOptions } from 'vscode-languageserver-protocol/lib/common/protocol';
/**
 * @since 3.17.0
 */
