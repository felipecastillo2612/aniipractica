...
import { MessageDirection, ProtocolRequestType, ProtocolRequestType0 } from 'vscode-languageserver-protocol/lib/common/messages';
import type { TextDocumentRegistrationOptions, WorkDoneProgressOptions, StaticRegistrationOptions, WorkDoneProgressParams } from 'vscode-languageserver-protocol/lib/common/protocol';
/**
